# from dynamixel_driver.System_Identification.Sim_executor import MuJoCo_Simulation_executor
from gymnasium_robotics.envs.training3.dynamixel_driver.System_Identification.Sim_executor import MuJoCo_Simulation_executor
from gymnasium_robotics.envs.training3.dynamixel_driver.System_Identification.simIHM_trajectory_collection import SimulationIHMWithObject
# from dynamixel_driver.System_Identification.simIHM_trajectory_collection import SimulationIHMWithObject
...
class ActuatorDR(MuJoCo_Simulation_executor, SimulationIHMWithObject):
    ...
    def randomise_parameter(self):
        ...
        self.env.unwrapped.model.geom_friction[1][0] = self.Randomise.uniform_randomise("floor_friction")
        pass
    ...
    def actuator_parameter_dr(self, duration, ID_, real_data, num_sim, test):
        t_list = []
        pos_list = []
        vel_list = []
        goal_list = []
        ...
        axs[0].legend(fontsize=6)  # Omit or modify if you don't need a legend for each trajectory
        ...
        axs[1].legend(fontsize=6)  # Omit or modify if you don't need a legend for each trajectory
...
if __name__ == "__main__":
    'Without object - calibration trajectory'
    # test = 0
    ...
    'Without object - short trajectory'
    # test = 0
    # env = gym.make("VariableFriction-v3")  # manual_policy
    ...
    'With object more-calibration like trajectory'
    # test = 1
    # env = gym.make("VariableFriction-v2")  # slide_trajectory
    # real_record_path = '/Users/qiyangyan/Desktop/FYP/Sim2Real/Model_Dynamics_20240310_191655.csv'

    'With object in calibration trajectory'
    test = 1
    env = gym.make("VariableFriction-v2")  # slide_trajectory
    ...
    sim_DR.actuator_parameter_dr(real_time[-1], ID_, df, 100, test)
