...
from gymnasium_robotics.envs.real4 import MujocoHandEnv
from gymnasium_robotics.utils import rotations
from scipy.spatial.transform import Rotation
from gymnasium_robotics.envs.real4.DomainRandomisation.randomisation import RandomisationModule
    ...
    class BaseManipulateEnv(HandEnvClass):
        def __init__(
            ...
            **kwargs,
            ...
            self.terminate_r_limit = [0.05,0.15]
            self.L = 0.015
            self.success = False
        ...
        def _is_success(self, achieved_goal, desired_goal):
            ...
            # print("check: ", np.mean(abs(d_radi)), success_radi, self.r_threshold)
            # if self.success:
                # print("check: ", d_radi)
            return success_radi
        ...
        def compute_reward_real(self, achieved_goal, goal, info):
            '''
            0: default
            1: smaller success reward
            2: without success reward
...
class MujocoManipulateEnv(get_base_manipulate_env(MujocoHandEnv)):
    ...
    def _get_obs(self):
        ...
        # print("Checkkk: ", self.goal.ravel()[-2:])
