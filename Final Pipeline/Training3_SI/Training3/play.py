...
class Play:
    ...
    def evaluate(self):
        ...
        for episode_idx in range(self.max_episode):
            print(episode_idx)
            ...
            for t in range(50):
                ...
                # print("check: ", state, action)

                ''' Action feasibility filter '''
                # the previous action result in these situations
                ...
                if friction_state_ != last_friction_:
                    ...
                    if terminated_ is False:
                        for _ in range(10):
                            ...
                            # print(action, r_dict["pos_control_position"],
                            #           r_dict["torque_control_position"])
                            r = r_dict["RL_IHM"]
                            ...
                            if r_dict["pos_control_position"] <= 0.03 \
                                    or r_dict["torque_control_position"] >= 1.65 \
                                    or terminated_ is True:
                                # print("terminate at: ", r_dict["pos_control_position"],
                                #       r_dict["torque_control_position"])
                                break
                else:
                    for _ in range(10):
