...
class Diffusion_QL(object):
    def __init__(self,
        ...
        checkpoint = torch.load('/Users/qiyangyan/Desktop/Training Files/Real4/Real4/result/VariableFriction.pth')
    ...
    def choose_action(self, joint_state, desired_goal, train_mode=False):
        ...
        state = np.concatenate([desired_goal, joint_state_norm])
