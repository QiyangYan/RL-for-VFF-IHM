...
class TrainEvaluateAgent(EnvironmentSetup):
    ...
    def run_episode_with_reset(self, train_mode):
        episode_dict = {
            "state": [],
            "action": [],
            "info": [],
        ...
        for epoch in range(MAX_EPOCHS):
            ...
            for cycle in range(0, MAX_CYCLES):
                ...
                for episode in range(MAX_EPISODES):
                    ...
                    episode_dict, _, _ = self.run_episode_with_reset(train_mode=True)
                ...
                if (cycle + 1) % 10 == 0 and cycle != 0:
                    success_rate, running_reward, episode_reward = self.eval_agent()
