...
def register_robotics_envs():
    ...
    for reward_type in ["sparse", "dense"]:
        ...
        register(
            ...
            entry_point="gymnasium_robotics.envs.variable_friction_discrete.manipulate_block:MujocoHandBlockEnv",
            kwargs=kwargs,
            max_episode_steps=100,
        )
        ...
        register(
            ...
            entry_point="gymnasium_robotics.envs.variable_friction_continuous.manipulate_block:MujocoHandBlockEnv",
            kwargs=kwargs,
            max_episode_steps=100,
        )
