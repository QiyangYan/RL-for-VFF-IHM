...
class Parameter_Tuning:
    def __init__(self, env):
        ...
        # IHM-like trajectory
        self.goal_pos_list_dyn = [1, 10, 100, 10, 10, 10, 200, 245, 10, 40, 50, 140, 245, 245, 10, 10, 10]
        ...
        # on object IHM-like trajectory
        # self.real_record_path = '/Users/qiyangyan/Desktop/FYP/Sim2Real/Model_Dynamics_20240308_175303.csv'

        'LEFT TORQUE'
        # self.torque = True
        # self.ID = 0
        # # self.initial_prms = [0.18494267, 0.02372372, 0.03176467]
        # self.initial_prms = [5.67185526e-02, 3.55878361e-03, 4.86429385e-07]
        # self.lb = [0, 0, -30]
        # self.ub = [10, 10, 30]
        ...
        self.calibration = MuJoCo_Simulation_executor(env_=env)
    ...
    def objective_function(self, prms):
        ...
        if self.torque:  # torque control
            ...
            self.sim_time, self.sim_pos, self.sim_vel, self.sim_control \
                = self.calibration.manual_policy(
                    self.ID,
                    goal_pos_list_dyn=self.goal_pos_list_dyn,
