...
class EvaluateDiffusion(TrainEvaluateAgent):
    def __init__(self, env_name, render, dataset, output_dir, model_idx, seed, layer_dim, include_action_in_obs,
                 ...
                 control_mode_indicator=False, seed_idx=None, real=False):
        super().__init__(
            env_name_=env_name,
            render=render,
            real=real,
    ...
    def eval_diffusion_with_rotation(self,
        ...
        for ep in range(num_episodes):
            ...
            if h1 == 1 and h2 == 1 and h3 == 1:
                episode_dict, success, _, _, _, slide_succeed \
                    = self.run_episode_E2E(real=real, reset=reset, train_mode=False, normalise=normalise, object=object)
            else:
                print("Stack")
            ...
            if success[-1] == 0:
                print("Not save")
                eval_history['success'].append(0)
            else:
                eval_history['success'].append(1)
                eval_history['pos_error_list'].append(pos_error)
                eval_history['orientation_error_list'].append(orientation_error)
            eval_history['pos_error_list_include_failure'].append(pos_error)
            eval_history['orientation_error_list_include_failure'].append(orientation_error)
            ...
            if (ep + 1) % 10 == 0:
                ...
                print(
                    f"| Pos error statics: mean = {np.mean(np.array(eval_history['pos_error_list']))}, std = {np.std(np.array(eval_history['pos_error_list']))}, median = {np.median(np.array(eval_history['pos_error_list']))}")
                print(
                    f"| Orientation error statics: mean = {np.mean(np.array(eval_history['orientation_error_list']))}, std = {np.std(np.array(eval_history['orientation_error_list']))}, median = {np.median(np.array(eval_history['orientation_error_list']))}")
                print(
                    f"| Pos error statics: mean = {np.mean(np.array(eval_history['pos_error_list_include_failure']))}, std = {np.std(np.array(eval_history['pos_error_list_include_failure']))}, median = {np.median(np.array(eval_history['pos_error_list_include_failure']))}")
                print(
                    f"| Orientation error statics: mean = {np.mean(np.array(eval_history['orientation_error_list_include_failure']))}, std = {np.std(np.array(eval_history['orientation_error_list_include_failure']))}, median = {np.median(np.array(eval_history['orientation_error_list_include_failure']))}")
        ...
        self.env.close()
        eval_history['success_rate'].append(sum(eval_history['success']) / len(eval_history['success']))
        return eval_history
...
if __name__ == "__main__":
    ...
    if args.eval_task_selection == 0:
        ...
        ' Cube: Rotation + Sliding + No Obj Vel '
        # output_dir_ = ['/Users/qiyangyan/Desktop/Diffusion/Demo_random/models_84_1024',
        #                '/Users/qiyangyan/Desktop/Diffusion/Demo_random/models_63_1024',
        #                ]
        # datapath = ['/Users/qiyangyan/Desktop/Diffusion/Demo_random/cube/train_10k_cube_slide_for_real',
        #             '/Users/qiyangyan/Desktop/Diffusion/Demo_random/cube_cylinder/train_bigSteps_10k_cube_cylinder_rotation_noObjVel']
        # model_idx_ = [3600,
        #               1500]
        # layer_dim_ = 1024
        # object = "cube"
        ...
        #                ]
        # datapath = ['/Users/qiyangyan/Desktop/Diffusion/Demo_random/cube_cylinder/train_bigSteps_10k_cube_cylinder_slide',
        #             '/Users/qiyangyan/Desktop/Diffusion/Demo_random/cube_cylinder/train_bigSteps_10k_cube_cylinder_rotation']
        # model_idx_ = [3300,
        #               1500]
        # layer_dim_ = 1024
        # normalise = True
        ...
        #                '/Users/qiyangyan/Desktop/Diffusion/Demo_random/models_63_1024',
        #                # '/Users/qiyangyan/Desktop/Diffusion/Demo_random/models_87_1024',
        #                ]
        # datapath = ['/Users/qiyangyan/Desktop/Diffusion/Demo_random/cube_cylinder/train_bigSteps_10k_cube_cylinder_slide_noObjVel',
        #             '/Users/qiyangyan/Desktop/Diffusion/Demo_random/cube_cylinder/train_bigSteps_10k_cube_cylinder_rotation_noObjVel',
        #             # '/Users/qiyangyan/Desktop/Diffusion/Demo_random/cube_cylinder/train_bigSteps_10k_cube_cylinder_rotation_noObjVel_forReal'
        #             ]
        # model_idx_ = [3300,
        #               1500]
        # layer_dim_ = 1024
        ...
        ' Cube cylinder: Rotation + Sliding 10000 demos + No Obj Vel + No Joint Vel'
        output_dir_ = ['/Users/qiyangyan/Desktop/Diffusion/Demo_random/models_86_1024',
                       '/Users/qiyangyan/Desktop/Diffusion/Demo_random/models_87_1024',
                       ]
        datapath = ['/Users/qiyangyan/Desktop/Diffusion/Demo_random/cube_cylinder/train_bigSteps_10k_cube_cylinder_slide_noObjVel_forReal',
                    '/Users/qiyangyan/Desktop/Diffusion/Demo_random/cube_cylinder/train_bigSteps_10k_cube_cylinder_rotation_noObjVel_forReal']
        model_idx_ = [2000,
                      1500]
        layer_dim_ = 1024
    ...
    print("Seed: ", seed)
    print("Seed value: ", seed_idx_list)
    ...
    for seed_idx in seed_idx_list:
        ...
        for key in eval_history.keys():
            eval_history_dict[key].append(eval_history[key])

    print(" ------------------------------------------------ ")
    print(" ------------------------------------------------ ")
    # print(eval_history_dict)
    # print(" ------------------------------------------------ ")

    # Now you can calculate mean, std, and median for each metric
